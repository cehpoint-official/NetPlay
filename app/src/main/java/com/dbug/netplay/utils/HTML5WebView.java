...
public class HTML5WebView extends WebView {
    ...
    private void init(Context context) {
        ...
        mBrowserFrameLayout = (RelativeLayout) LayoutInflater.from(a).inflate(R.layout.vimeo_custom_screen, null);
        ...
        s.setGeolocationDatabasePath("/data/data/com.dbugcdcn.streamit/databases/");
        ...
        mContentView.setBackgroundColor(ContextCompat.getColor(context, R.color.black));
    }
        ...
        public Bitmap getDefaultVideoPoster() {
            ...
            if (mDefaultVideoPoster == null) {
                mDefaultVideoPoster = BitmapFactory.decodeResource(
                        getResources(), R.drawable.dkplayer_ic_action_pause);
            }
